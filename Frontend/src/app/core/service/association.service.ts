...
import { AssociationResponse } from '../interface/AssociationResponse-interface';
...
export class AssociationService {
  ...
  getPosition(position: string): Observable<Field> {
    const params = new HttpParams().set('position', position);
    return this.http.get<Field>(`${BASE_ULR}/fields/search`, { params });
  }
